...
import { addPanier, removePanier, clearPanier } from "./state/panier/panierSlice";
        ...
        <div className="p-4">
            ...
            <div className="flex justify-between gap-20">
                ...
                <div className="w-1/2 border border-gray-300 p-4">
                    ...
                    {panier.map((panier) => (
                        <div key={panier.id} className="flex justify-between items-center mb-4">
                            <div>
                                <h3 className="text-lg font-semibold">{panier.name}</h3>
                                <p>Price: ${panier.price}</p>
                                <p>Quantity: {panier.quantity}</p>
                            </div>
                            <button
                                onClick={() => handleDelete(panier.id)}
